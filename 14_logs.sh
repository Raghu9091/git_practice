#!/bin/bash
# logs improing redirecte same output terminal and log file 
...
mkdir -p $LOGS_FOLDER
echo "Script started executing at: $(date)" | tee -a $LOG_FILE  # this out put stored file and showing output terminal as well
